...
import { FaPlus, FaComments, FaBars, FaTimes } from "react-icons/fa";
...
function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        className="fixed top-12 left-0 z-50 md:hidden bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-full p-3 text-white shadow-lg hover:bg-gray-800/90 transition-all duration-200"
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 pt-16 h-screen w-80 bg-gray-900/95 backdrop-blur-xl border-r border-gray-700/50 z-40 flex flex-col transition-transform duration-300 ease-in-out ${
          showSidebar ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0`}
      >
        {/* Header Section */}
        <div className="p-6 border-b border-gray-700/50 flex-shrink-0 mt-16 md:mt-0">
          {/* Title Input */}
